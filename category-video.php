...
<div class="main-container">
    <img class="title title-2" src="<?php echo get_bloginfo('template_url'); ?>/img/title-video.png">
    <figure><img class="bannerImg" src="<?php echo get_bloginfo('template_url'); ?>/img/21-banner.jpg"></figure>
        ...
        <div class="posts">
            ...
            <?php while ( have_posts() ) : the_post(); ?>
                <a href="javascript:showPageInfo( '<?php the_permalink() ?>' ); "><article>
                    ...
                    <img class="btnPlay" src="<?php echo get_bloginfo('template_url'); ?>/img/icon-play.png" alt="">
