...
<div class="main-container">
    <img class="title title-2" src="<?php echo get_bloginfo('template_url'); ?>/img/title-3D.png">
    <figure><img class="bannerImg" src="<?php echo get_bloginfo('template_url'); ?>/img/23-banner.jpg"></figure>
